...
"""########################################"""
"""
  SVHN Input Interface
"""
"""########################################"""

def load_data():
  """Load data from a pickle file or download the data and extract it"""
...
def accuracy(predictions, labels):
  return svhn_eval.accuracy(predictions, labels)
